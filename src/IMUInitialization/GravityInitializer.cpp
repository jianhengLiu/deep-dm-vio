/*
 * @Author: Jianheng Liu
 * @Date: 2022-03-27 14:07:16
 * @LastEditors: Jianheng Liu
 * @LastEditTime: 2022-03-30 17:16:23
...
/**
 * @brief 利用历史所有加速度计信息获得重力方向
 * 
 * @param imuData 
 * @return Sophus::SE3d T_i2w(位移为0)
 */
Sophus::SE3d
GravityInitializer::addMeasure(const IMUData& imuData)
{
    int numMeasure = 0;
