...
namespace IOWrap {
    ...
    public:
        ...
        virtual void pushLiveFeatureFrame(FrameHessian* image) override;
    ...
    private:
        ...
        MinimalImageB3* internalFeatureImg;
        MinimalImageB3* internalKFImg;
        MinimalImageB3* internalResImg;
        bool videoImgChanged, featureImgChanged, kfImgChanged, resImgChanged;
