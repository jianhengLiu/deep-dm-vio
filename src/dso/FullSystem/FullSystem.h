...
public:
    ...
    void addActiveFrame(ImageAndExposure* image, ImageAndExposure* featureImage, int id, dmvio::IMUData* imuData, dmvio::GTData* gtData);
...
private:
    ...
    EnergyFunctional* ef; //!< 能量方程 energy function
