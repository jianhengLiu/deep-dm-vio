...
public:
    ...
    EFFrame* insertDeepFrame(FrameHessian* fh, CalibHessian* Hcalib);
    ...
    void setDeepDeltaF(CalibHessian* HCalib);

    void setAdjointsF(CalibHessian* Hcalib);
    void setDeepAdjointsF(CalibHessian* Hcalib);
    ...
    std::map<uint64_t, // 历史ID
        ...
        Eigen::aligned_allocator<
            std::pair<const uint64_t, Eigen::Vector2i>> // 64位对齐
        >
